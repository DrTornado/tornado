...
android {
    ...
    buildTypes {
        release {
            ...
            /*
             * مفتاح النشر إن وُجد، ومفتاح التطوير إن لم يوجد — والسقوط يُعلَن.
             *
             ...
             *
             * لكنه كان يقع **صامتاً**. ونُقل المفتاح يوماً خارج الجهاز، فبقي
             * البناء يخرج أخضر بمفتاحٍ آخر — ونسخةٌ بمفتاحٍ آخر لا تُثبَّت فوق
             * القائمة على الجوال: يطلب أندرويد حذف التطبيق أوّلاً، ومعه مكتبة
             * صاحبه. فالسقوط يُقال الآن في سطرٍ لا يُخطئه النظر.
             */
            val release = signingConfigs.findByName("tornado")
            if (release == null) {
                logger.warn(
                    "\n" +
                    "  ┌──────────────────────────────────────────────────────────┐\n" +
                    "  │  تحذير: مفتاح النشر غير موجود — التوقيع بمفتاح التطوير    │\n" +
                    "  │  هذه النسخة لا تُثبَّت فوق المنشورة على الجوال            │\n" +
                    "  │  المسار المتوقَّع:                                        │\n" +
                    "  │  ~/OneDrive/Desktop/TORNADO-PLAY/SIGNING-KEY/            │\n" +
                    "  └──────────────────────────────────────────────────────────┘\n"
                )
            }
